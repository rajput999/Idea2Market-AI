    ...
    <div className={classes.body_total}>
        <div className={classes.m_body}>
            <div className={classes.search}>
                <div className={classes.main_input}>
                    ...
                    <div className={classes.image_gen}>
                        <img src={image_url==='/'?imge:image_url} className={classes.img_gen} alt="Generated by ai"/>
                    </div>
                </div>
            ...
            <div className={classes.rec_main}>
                <div>
                    {
                      recRslt===''?<img src={recLoader} style={{height: "10vh",marginTop: "10vh"}} alt="not generated"/>
                      :<div>
